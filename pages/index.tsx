    ...
    <div className="mt-5">
      <div className="flex flex-col lg:flex-row md:flex-row justify-between">
        <div className="lg:mt-40 md:mt-20 mt-10 lg:ml-10">
          <h1 className="text-gray-700 lg:text-3xl text-2xl font-semibold">
            Save money and transform the world
          </h1>
          <h2 className="text-yellow-300 lg:text-2xl text-xl font-semibold">
            Transaction by transaction
          </h2>
          <div className="my-10">
            <Link href="/welcome" passHref>
              <a className="p-2.5 px-3 rounded-full text-base bg-gray-300 text-gray-700 font-semibold hover:bg-yellow-300 hover:text-gray-700 transition cursor-pointer">
                join Sumbyte.
              </a>
            </Link>
          </div>
