...
const services = [
  {
    ...
    styleActiveButton: "px-6 py-4 inline-flex text-sm leading-5 font-normal rounded-full bg-terra-green-300 text-green-800",
    activeText: "Active"
  },
  {
    id: 2,
    title: 'Add + 1 % on transactions',
    type: 'Total 2 %',
    location: 'Remote',
    ...
    styleActiveButton: "px-6 py-4 inline-flex text-sm leading-5 font-normal rounded-full bg-terra-purple-100 hover:bg-terra-purple-200 text-gray-800",
    activeText: "Activate"
  },
  {
    id: 3,
    title: 'Add 3 % on one random transaction per week',
    type: 'Full-time',
    location: 'Remote',
    department: 'Optional selection',
            ...
            <a href="#" className={position.style}>
              <div className="px-4 py-2">
                <div className="flex items-center justify-between">
                  <p className="text-xl font-normal text-terra-purple-600 truncate">{position.title}</p>
