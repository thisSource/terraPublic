...
function MarketButton(props: { href: string; market: string }) {
  return (
    <a
      className="flex items-center px-8 py-4 border border-transparent text-sm font-medium rounded-md text-terra-purple-700 bg-terra-purple-100 hover:bg-terra-green-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-terra-green-500"
      href={props.href}
    >
      {props.market}
    </a>
...
export default function TinkLinkLogin() {
  return (
    <div className="mx-8 my-20 p-10 bg-terra-purple-300 rounded-xl">
